            ...
            if (mShowPercentAsAutoValue) {
            	...
            	if (_degrees > 345) {
            		_degrees = 360;
					 ...
					 percent = (int) (100 / mMaxValue * mCurrentValue)/10;
				}
               
                text = String.valueOf(percent);
            } else {
                text = String.valueOf((int) mCurrentValue / 100);
            }
        }
                ...
                case SPINNING:
                    switch (msgType) {
                        ...
                        case TICK:
                            ...
                            if (circleView.mCurrentSpinnerDegreeValue > 345 && circleView.mCurrentSpinnerDegreeValue < 360 ) {
                                circleView.mCurrentSpinnerDegreeValue = 360;
                            }else if (circleView.mCurrentSpinnerDegreeValue > 360) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                mValue = (int) (mMaxValue / 360f * angle);
                return true;
            }
